...
use crate::handlers::{auth_routes, container_routes, health_routes, image_routes, project_routes, system_routes};
use crate::handlers::auth::protected_auth_routes;
use crate::middleware::auth_middleware;
use crate::services::{AuthService, ContainerService, ProjectService};
...
async fn main() -> anyhow::Result<()> {
    ...
    // Add container routes if available
