...
Pada beberapa filesystem di perangkat ARM, mount Docker terhadap file yang belum ada bisa memicu pembuatan folder kosong. Labuh v0.4.0+ telah dilengkapi fitur **Auto-Repair**:
